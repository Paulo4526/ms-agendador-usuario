...
public class JwtUtil {
    ...
    // Chave secreta codificada em base64 usada para assinar e verificar tokens JWT
    private static final String SECRETKEY = "c3VhLWNoYXZlLXNlY3JldGEtc3VwZXItc2VndXJhLXF1ZS1kZXZlLXNlci1iZW0tbG9uZ2E=";

    //Metodo que decodifica a secretKey codificada em base64
    private SecretKey getSecretKey(){
        byte[] key = Base64.getDecoder().decode(SECRETKEY);
        return Keys.hmacShaKeyFor(key);
    }

    // Gera um token JWT com o nome de usuário e validade de 1 minuto
    public String generateToken(String username) {
        return Jwts.builder()
                ...
                .expiration(new Date(System.currentTimeMillis() + 1000 * 60)) // Define a data e hora de expiração (1 minuto após a emissão do token)
